...
Đây là ví dụ về trình soạn thảo markdown của chúng tôi, mọi người hãy truy cập trang web [Codetube.vn - Business Plan](https://codetube.vn/business) để thấy tài liệu này được hiển thị trên web với các thành phần UI đặc biệt.
...
Chúng tôi xuất thân là sinh viên IT và sau này trở thành lập trình viên, hiểu rất rõ vấn đề này và dựa trên nhiều năm kinh nghiệm của mình đã nghĩ ra giải pháp hiệu quả hơn để học thuật toán đó là lập trình mô phỏng hoạt động của thuật toán bao gồm từng trạng thái và cách chuyển trạng thái thuật toán 1 cách trực quan và tổng quát cho tất cả các trường hợp dựa trên input của người dùng. Người dùng tương tác để chuyển đến bất kỳ trạng thái nào mong muốn với hiệu ứng chuyển động sinh động, từ đó gây hứng thú cũng như dễ dàng kiểm chứng, hiểu rõ hơn và nắm bắt từng khía cạnh của thuật toán, các case thông thường, case đặc biệt...thay vì phải đọc các lý giải bằng chữ rất dài và khó hình dung.

Ngoài ra để tăng khả năng mở rộng và chuyên biệt hoá từng công đoạn chúng tôi đóng gói các mô phỏng trực quan này và cho phép người dùng (người dạy học) sử dụng chúng trong bài viết 1 cách dễ dàng thông qua việc sử dụng cú pháp Markdown mà không cần code.
...
Hướng đi ban đầu chúng tôi tìm kiếm các trường học, tổ chức có nhu cầu dạy về lập trình, hợp tác chặt chẽ để tạo ra các thành phần trực quan phù hợp nhất đồng thời đáp ứng nhu cầu về tính độc đáo cá nhân hóa (peronalized) cho từng đơn vị cụ thể. Bên cạnh đó có thể giúp đơn vị mở rộng thương mại hóa khóa học của mình online trên phạm vi global nếu muốn.
...
- Hỗ trợ hiển thị nội dung người dùng theo cách sinh động bằng cách sử dụng cú pháp markdown mở rộng:
  - Các thành phần mô phỏng thuật toán trực quan, có thể mở rộng ra toán học, vật lý cũng như mô phỏng các lĩnh vực khoa học khác.
